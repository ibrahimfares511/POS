...
@section('content')
  <div id="wrapper" class='toggled-2'>
    ...
    <div id="saletype" sale="{{ $salsetype->buyopration }}"></div>
              ...
              <div class="col-lg-4">
                ...
                <div class="portlet sale-form">
                  ...
                  <div class="product-form">
                    ...
                    <div class="main-input input-group">
                      <input type="text" wholesale_price="" retailsale_price="" buy_price="" pieces="" class="form-control" placeholder='اسم المنتج' id='item_name'>
                      <div class="input-group-prepend">
                    ...
                    @can('سعر الشراء')
                    <div class="main-input input-group mb-3">
                      <input type="number" class="form-control" id='buy_price' placeholder='سعر الشراء'>
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-money-bill-wave"></i></span>
                      </div>
                    </div>
                    @endcan
                    @can('سعر البيع الجملة')
                    <div class="main-input input-group mb-3">
                      <input type="number" class="form-control" id='wholesale_price' placeholder='سعر الجملة'>
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-money-bill-alt"></i></span>
                      </div>
                    </div>
                    @endcan
                    @can('سعر البيع القطاعي')
                    <div class="main-input input-group mb-3">
                      <input type="number" class="form-control" id='retailsale_price' placeholder='سعر القطاعى'>
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="far fa-money-bill-alt"></i></span>
                      </div>
                    </div>
                    @endcan
                    @can('الخصم علي منتج فاتورة مشتريات')
                    <div class="main-input input-group">
                    ...
                    @endcan
                      <div class="main-input input-group mb-3">
                        <input type="date" class="form-control" id="expired" placeholder='انتهاء الصلاحية'>
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                        </div>
                      </div>
                    @if($salsetype->buyopration == "direct")
...
@include('ajax.purchases.purchasing')
@endsection
