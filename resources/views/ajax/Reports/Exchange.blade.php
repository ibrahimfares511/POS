        ...
        success: function (data) {
            ...
            for(var count = 0 ; count < data.length ; count++)
            {
                html +=`<tr row_id='${data[count].id}'>
                      ...
                      <td> <span>${data[count].customers.customer}</span> </td>
                      <td> <span>${data[count].val}</span> </td>
                      <td> <span>${data[count].forhim}</span> </td>`

                    if(type == "delete"){
                        html+=`<td> <span>${data[count].user_delete[0].name}</span> </td>`

                    }else{
                        html+=`<td> <span>${data[count].users.name}</span> </td>`
